...
final class UIShiftyZoomyAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    private static let animationDampingRatio: CGFloat = 0.85
    ...
    private typealias `Self` = UIShiftyZoomyAnimationController
